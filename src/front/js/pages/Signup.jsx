        ...
        <div id="signup-left-wrapper" className="w-50">
          ...
          {store.errorSignup ? (
            <div className="rounded signup-warning text-white p-3">
              Una cuenta con el email seleccionda ya está creada. Por favor,{" "}
              <Link to="/login">ingresa a tu perfil</Link>.
            </div>
          ) : null}
          <form
            onSubmit={handleSubmit}
            id="signup-form input-group"
            className="d-flex flex-column"
            noValidate
          >
            <div id="user-first-name" className="d-flex flex-row m-3">
              <label
                className="opacity-50 signup-icon"
            ...
            <div>
              {errors.firstName ? (
                <div className="rounded signup-warning text-white mx-3 p-1">
                  {errors.firstName}
                </div>
              ) : null}
            </div>
            ...
            <div className="form-check mb-0 mt-3 ms-3">
              ...
              />
              <label
                className="form-check-label tos-acceptance-text"
                htmlFor="check-tos"
              >
            ...
            {errors.requireTOS ? (
              <div className="rounded signup-warning text-white mx-3 mt-1 p-1">
                {errors.requireTOS}
              </div>
            ) : (
              ""
            ...
            <div className="d-flex justify-content-center">
              <Link to="/home" className="link-secondary text-center">
