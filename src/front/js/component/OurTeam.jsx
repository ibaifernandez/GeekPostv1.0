...
export const OurTeam = () => (
    <section id="team" className="team section-pure-white-bg px-3 pb-5">
  <div className="container" data-aos="fade-up">
    <div className="section-title">
      <h2 className="pt-3 mt-3">El equipo</h2>
  ...
  <div className="container mt-3">
    <div className="row">
      {teamData.map(({ id, image, alt, name, title, description, twitter, facebook, instagram, linkedin, github }) => (
        <div key={id} className="col-md-6 col-lg-6 p-lg-3 p-md-2 p-sm-1" data-aos="zoom-in" data-aos-delay="100">
