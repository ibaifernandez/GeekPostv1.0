...
export const OurTeam = () => (
    <section id="team" className="team section-bg px-3">
  <div className="container" data-aos="fade-up">
    <div className="section-title">
      <h2 className="pt-5">El equipo</h2>
      <h3>3Geeks @ 4Geeks</h3>
      <p className="our-team-p">
        Mejor que tener a tres Messi en la delantera, es tener a este equipo. Te juegan lo mismo en el back-end, que 
        en el front-end; tienen un control del Visual Studio Code que ya quisieran otros. Y lo mejor: ahora mismo, 
        como novatos que son, están a precio de ganga.
      </p>
    </div>
  </div>
